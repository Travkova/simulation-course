...
class HeatEquationGUI:
    ...
    def create_widgets(self):
        ...
        self.entry_T_initial.insert(0, "20.0")
        ...
        self.entry_rho.insert(0, "2700.0")
        ...
        self.entry_c.insert(0, "900.0")
        self.entry_c.grid(row=1, column=3, padx=5, pady=2)

        ttk.Label(params_frame, text="Теплопроводность λ (Вт/(м·K)):").grid(row=1, column=4, sticky=tk.W)
        self.entry_lambda = ttk.Entry(params_frame, width=10)
        self.entry_lambda.insert(0, "230.0")
